        ...
        <div class="card">
          <div class="card-body">
            ...
            <h1 class="mb-3">
              ...
              <small class="text-muted">2.1875rem (35px)</small>
            </h1>

            <h2 class="mb-3">
              h2. Bootstrap heading
              <small class="text-muted">1.75rem (28px)</small>
            </h2>

            <h3 class="mb-3">
              h3. Bootstrap heading
              <small class="text-muted">1.53125rem (24.5px)</small>
            </h3>

            <h4 class="mb-3">
              h4. Bootstrap heading
              <small class="text-muted">1.3125rem (21px)</small>
            </h4>

            <h5 class="mb-3">
              h5. Bootstrap heading
              <small class="text-muted">1.09375rem (17.5)</small>
            </h5>

            <h6>
              h6. Bootstrap heading
              <small class="text-muted">0.875rem (14px)</small>
            </h6>
          </div>
        </div>
        <!-- end card -->
