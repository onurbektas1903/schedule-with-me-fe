        ...
        <div class="card">
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="p-3">
                  <h5 class="font-size-14 mb-3 mt-0">Custom slider</h5>
                  <div class="px-3">
                    <VueSlideBar v-model="value" class="mb-2" />
                    <b-button variant="light" @click="value--">
                      <span class="font-size-17"> - </span>
                    </b-button>
                    <b-button variant="light" class="ms-1" @click="value++">
                      <span class="font-size-17"> + </span>
                    </b-button>
                  </div>
                </div>
